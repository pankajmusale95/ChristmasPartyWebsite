...
<link
	href="https://fonts.googleapis.com/css2?family=Alkalami&family=Inter:wght@500&display=swap"
	rel="stylesheet">
...
.body {
	background-image:
		url('https://i.pinimg.com/originals/4f/93/20/4f932047f96fa94a01bf0f51cada47e9.gif');
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="85"
		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				<a class="navbar-brand" href=""> <img
					src="./resoureces/images/logo.png" class="img-fluid" alt="logo">
				</a>
				...
				<div class="collapse navbar-collapse justify-content-end"
					id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link" href="Event-M.html"><b>Mumbai</b></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="Event-D.html"><b>Delhi</b></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="Event-K.html"><b>Kolkata</b></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="Event-B.html"><b>Bangluru</b></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="contact.html"><b>Contact</b></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="gifts.html"><b>LuckyDraw</b></a>
						</li>
						<li class="nav-item"><a class="nav-link" href="index.html"><b>Logout</b></a>
						</li>
					</ul>
				</div>
			</div>
	...
	<div style="display: flex;">
		<div style="padding: 100px; display: inline;">
			<section class="row sec10">
				<div class="col-lg-6 col-xs-10" id="sec10_img">
					<img src=".//resoureces//R1.jpeg" alt=""
		...
		<div style="padding: 100px; display: inline;">
			<section class="row sec10">
				<div class="col-lg-6 col-xs-10" id="sec10_img">
					<img src=".//resoureces//R3.jpeg" alt=""
						style="height: 380px; width: 350px; box-shadow: 0 0px 70px rgb(0, 0, 0); border-radius: 20px;">
				</div>
			</section>
		</div>
	...
	<%-- <sql:setDataSource var="db" driver="com.mysql.jdbc.Driver"
		url="jdbc:mysql://localhost/ChristProject" user="root"
		password="Yogesh@1996"></sql:setDataSource>
